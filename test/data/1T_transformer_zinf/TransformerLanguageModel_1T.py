...
class TransformerLanguageModel_1T(Network):
    def __init__(
            ...
            head_divide=1,  # Dividing factor for num_heads (model parallelism)
            d_ff_divide=1,  # Dividing factor for d_ff (model parallelism)
            vocab_divide=1,  # Dividing factor for vocab_size (model parallelism)
            verbose=False,
            userInput=None):
        '''
